# Proto UI 기반으로 생성된 DataTool UI 파일
# 소스: DataTool_optRCD_proto_.py의 Ui_sitool 클래스
#
# 주의: 이 파일은 proto 파일의 UI 코드와 동기화됩니다.
# DataTool_UI.ui로 표현할 수 없는 위젯(QScrollArea, ButtonGroup, 커스텀 delegate 등)이 포함됩니다.
...
class Ui_sitool(object):
    def setupUi(self, sitool):
        ...
        # tabCloseRequested 는 WindowClass에서 연결
