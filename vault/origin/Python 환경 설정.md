...
- Visual Studio 2017 Deskop Express :  **[vs_WDExpress.exe](https://confluence-mx.sec.samsung.net/download/attachments/1438905080/vs_WDExpress.exe?version=1&modificationDate=1667368361000&api=v2)**
- [IT4U](http://it4u.sec.samsung.net/itvoc/jsp/new/common/menu/frame.jsp)  - PC S/W 라이선스 관리 - S/W 자료실 - "MS Visual Studio Express(무료 버전) 사용 방법" 참고
- |Visual Studio Express 제품은 별도 구매 없이  <br>개인 및 기업에서 무료로 사용할 수 있습니다.  <br>  <br>아래의 URL을 통해, 사용자의 목적에 맞는 플랫폼의  <br>Visual Studio Express 버전을 설치/사용 하시기 바랍니다.  <br>  <br>[http://www.visualstudio.com/ko-kr/products/visual-studio-express-vs.aspx](http://www.visualstudio.com/ko-kr/products/visual-studio-express-vs.aspx)  <br>※ 페이지 접속 후 바로 표기되는  **Community 2022 다운로드 버전은 사내에서 사용불가**  입니다.  <br>※ 페이지 제일  **하단** 에 있는  **"Visual Studio Express를 계속 사용하시겠습니까?"**  에 표기되는  <br>**Express 버전**  중에서 선택  <br>  <br>※제품 다운로드 및 인증을 위해서는 MS 계정을 보유하여야 하며,  <br>회원가입을 통해 계정 등록을 하셔야 합니다.  <br>(개인의 Knox이메일주소로 직접 MS Site내 계정 생성 및 등록)  <br>설치 후 30일 이내에 제품 등록을 하셔야 장기간 사용 가능 합니다.  <br>  <br>전사 SW비용 효율화를 위하여 Visual Studio Express 버전으로 업무/교육이 충분할 경우,  <br>기업내에서도 무료 사용 가능한 Express 버전을 사용하시기 바랍니다.|
    |---|
...
- Visual Studio 2019 Professional :  **[vs_professional__1541101388.1573193901.exe](https://confluence-mx.sec.samsung.net/download/attachments/1438905080/vs_professional__1541101388.1573193901.exe?version=1&modificationDate=1667368945000&api=v2)**
