...
> 📎 2026-04-21: `260404_review_profile_render_loop` 병합 (학습 / Strategy Pattern 설명 섹션 흡수)
...
## 학습 / Strategy Pattern 설명

> 이하 내용은 `260404_review_profile_render_loop` (2026-04-04) 에서 병합됨.
> `_profile_render_loop()` 의 작동원리, Strategy Pattern 개념, 클로저/콜백 패턴, 채널맵 구조 등 학습 자료.
...
이 3-모드 분기 로직이 6개 버튼에 각각 200~280줄씩 **복사-붙여넣기**되어 있었다. 6개 버튼을 비교하면, 차이점은 **하나의 (채널, 사이클) 쌍에 대해 무엇을 그리느냐** 뿐이다.
...
### Python 기법: 클로저(Closure)와 콜백(Callback)
...
#### `getattr(obj, attr_name)` — 동적 속성 접근
